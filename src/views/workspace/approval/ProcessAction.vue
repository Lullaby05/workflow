<template>
  <div>
    ...
    <div v-if=" action === 'transfer' || action === 'beforeAdd' || action === 'afterAdd'" style="margin-bottom: 10px">
      ...
      <el-button style="margin-right: 20px" size="small" icon="el-icon-user" @click="selectUser">选择人员</el-button>
    ...
    <div v-if="showSignCt">
      ...
      <div class="sign">
        <el-button @click="showSignPanel" icon="el-icon-edit">点击签名</el-button>
        <img v-show="actionData.signature.length > 0" :src="actionData.signature" @click="showSignPanel">
      </div>
