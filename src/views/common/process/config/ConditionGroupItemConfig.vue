    ...
    <div v-for="(group, index) in selectedNode.props.groups" :key="index + '_g'" class="group">
      <div class="group-header">
        ...
        <div class="group-operation">
          ...
          <icon name="el-icon-delete" @click="delGroup(index)"></icon>
        </div>
      </div>
          ...
          <el-form ref="condition-form" label-width="100px">
            ...
            <el-form-item  v-for="(condition, cindex) in group.conditions" :key="condition.id + '_' + cindex" >
              ...
              <span v-else-if="condition.valueType === ValueType.user">
                ...
                <el-button size="small" icon="el-icon-plus" type="primary" @click="selectUser(condition.value, 'org'); condition.compare = 'ORG'" round>选择人员/部门</el-button>
              ...
              <span v-else-if="condition.valueType === ValueType.dept">
                ...
                <el-button size="small" icon="el-icon-plus" type="primary" @click="selectUser(condition.value, 'dept'); condition.compare = 'DEPT'" round>选择部门</el-button>
                <org-items v-model="condition.value"/>
              </span>
              <span v-else-if="condition.valueType === ValueType.date"></span>
              <icon name="el-icon-delete" @click="rmSubCondition(group, cindex)"></icon>
            </el-form-item>
          </el-form>
        </div>
      </div>
