<template>
  <div class="senior-setup">
    <el-form label-position="top" label-width="80px">
      ...
      <el-form-item label="允许发起人撤销流程">
        <el-switch v-model="setup.enableCancel"></el-switch>
        <span class="sign-tip">开启后，发起人将可以随时撤销进行中的流程</span>
      </el-form-item>
      <el-form-item label="打印模板">
        <el-switch inactive-text="系统默认" active-text="自定义" v-model="setup.customPrint"></el-switch>
        <el-button size="small" style="margin-left: 20px" @click="editPrint" v-if="setup.customPrint" icon="el-icon-document">去编辑模板</el-button>
