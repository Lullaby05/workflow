      ...
      condition() {
        switch (this._value.fieldType) {
          ...
          case 'CalcFormula':
            return {
              name: 'numCompare',
              options: compareOptions.numCompareOptions,
            };
          case 'TextInput':
          case 'TextareaInput':
          case 'SelectInput':
          ...
          case 'MultipleSelect':
            return {
              name: 'strArrCompare',
              options: compareOptions.strArrCompareOptions,
            };
          case 'DateTime':
            return {
              name: 'timeCompare',
              options: compareOptions.timeCompareOptions,
            };
          case 'DateTimeRange':
            return {
              name: 'timeArrCompare',
              options: compareOptions.timeArrCompareOptions,
            };
          case 'DeptPicker':
          case 'UserPicker':
            return {
              name: 'orgCompare',
              options: compareOptions.orgCompareOptions,
            };
          default:
            return { name: 'div', options: [] };
        }
      },
    },
    data() {
