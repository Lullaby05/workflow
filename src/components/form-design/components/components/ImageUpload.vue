<template>
  <div>
    ...
    <div v-else-if="mode === 'MOBILE' && !readonly">
      <uploader v-model="fileList" :multiple="maxNumber > 1" :max-count="maxNumber > 0 ? maxNumber : 99" deletable :before-delete="handleRemove" :before-read="beforeUpload" upload-text="选择图片" :after-read="afterRead" :max-size="maxSize * 1024 * 1024" @oversize="onOversize" />
